      ...
      <div className='w-full'>
        ...
        <div>
          {imageUrls.length > 0 ? (
            ...
            {/* Tombol navigasi */}
            <div className="absolute sm:top-[290px] top-[180px] left-[10px] right-[10px] flex justify-between items-center z-10 py-2">
              <button
                onClick={scrollLeft}
                className="material-icons text-white text-4xl opacity-30"
              >
                arrow_circle_left
              </button>
              <button
...
//  All working tapi fitur carosel belum sempurna
// // frontend/app/public/object/tryfe/[id]/page.jsx
// 'use client';
...
// all working tapi masih bisa export dalam bahasa selain inggris
// // frontend/app/public/object/tryfe/[id]/page.jsx
// 'use client';
